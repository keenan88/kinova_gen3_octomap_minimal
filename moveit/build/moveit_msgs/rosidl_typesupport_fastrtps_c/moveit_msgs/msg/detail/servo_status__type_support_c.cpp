...
#include "moveit_msgs/msg/detail/servo_status__rosidl_typesupport_fastrtps_c.h"
...
using _ServoStatus__ros_msg_type = moveit_msgs__msg__ServoStatus;
...
static uint32_t _ServoStatus__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_moveit_msgs__msg__ServoStatus(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = moveit_msgs__msg__ServoStatus;
    is_plain =
      (
...
static size_t _ServoStatus__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_moveit_msgs__msg__ServoStatus(
