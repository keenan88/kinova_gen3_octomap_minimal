...
set_target_properties(moveit_ros_control_interface::moveit_ros_control_interface_plugin PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libmoveit_ros_control_interface_plugin.so.2.9.0"
  IMPORTED_SONAME_RELEASE "libmoveit_ros_control_interface_plugin.so.2.9.0"
  )

list(APPEND _IMPORT_CHECK_TARGETS moveit_ros_control_interface::moveit_ros_control_interface_plugin )
list(APPEND _IMPORT_CHECK_FILES_FOR_moveit_ros_control_interface::moveit_ros_control_interface_plugin "${_IMPORT_PREFIX}/lib/libmoveit_ros_control_interface_plugin.so.2.9.0" )
...
set_target_properties(moveit_ros_control_interface::moveit_ros_control_interface_trajectory_plugin PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libmoveit_ros_control_interface_trajectory_plugin.so.2.9.0"
  IMPORTED_SONAME_RELEASE "libmoveit_ros_control_interface_trajectory_plugin.so.2.9.0"
  )

list(APPEND _IMPORT_CHECK_TARGETS moveit_ros_control_interface::moveit_ros_control_interface_trajectory_plugin )
list(APPEND _IMPORT_CHECK_FILES_FOR_moveit_ros_control_interface::moveit_ros_control_interface_trajectory_plugin "${_IMPORT_PREFIX}/lib/libmoveit_ros_control_interface_trajectory_plugin.so.2.9.0" )
...
set_target_properties(moveit_ros_control_interface::moveit_ros_control_interface_gripper_plugin PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libmoveit_ros_control_interface_gripper_plugin.so.2.9.0"
  IMPORTED_SONAME_RELEASE "libmoveit_ros_control_interface_gripper_plugin.so.2.9.0"
  )

list(APPEND _IMPORT_CHECK_TARGETS moveit_ros_control_interface::moveit_ros_control_interface_gripper_plugin )
list(APPEND _IMPORT_CHECK_FILES_FOR_moveit_ros_control_interface::moveit_ros_control_interface_gripper_plugin "${_IMPORT_PREFIX}/lib/libmoveit_ros_control_interface_gripper_plugin.so.2.9.0" )
...
set_target_properties(moveit_ros_control_interface::moveit_ros_control_interface_empty_plugin PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libmoveit_ros_control_interface_empty_plugin.so.2.9.0"
  IMPORTED_SONAME_RELEASE "libmoveit_ros_control_interface_empty_plugin.so.2.9.0"
  )

list(APPEND _IMPORT_CHECK_TARGETS moveit_ros_control_interface::moveit_ros_control_interface_empty_plugin )
list(APPEND _IMPORT_CHECK_FILES_FOR_moveit_ros_control_interface::moveit_ros_control_interface_empty_plugin "${_IMPORT_PREFIX}/lib/libmoveit_ros_control_interface_empty_plugin.so.2.9.0" )
