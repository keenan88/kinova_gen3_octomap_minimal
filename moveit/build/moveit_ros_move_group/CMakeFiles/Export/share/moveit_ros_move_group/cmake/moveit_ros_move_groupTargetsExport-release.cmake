...
set_target_properties(moveit_ros_move_group::moveit_move_group_default_capabilities PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libmoveit_move_group_default_capabilities.so.2.9.0"
  IMPORTED_SONAME_RELEASE "libmoveit_move_group_default_capabilities.so.2.9.0"
  )

list(APPEND _IMPORT_CHECK_TARGETS moveit_ros_move_group::moveit_move_group_default_capabilities )
list(APPEND _IMPORT_CHECK_FILES_FOR_moveit_ros_move_group::moveit_move_group_default_capabilities "${_IMPORT_PREFIX}/lib/libmoveit_move_group_default_capabilities.so.2.9.0" )
...
set_target_properties(moveit_ros_move_group::moveit_move_group_capabilities_base PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libmoveit_move_group_capabilities_base.so.2.9.0"
  IMPORTED_SONAME_RELEASE "libmoveit_move_group_capabilities_base.so.2.9.0"
  )

list(APPEND _IMPORT_CHECK_TARGETS moveit_ros_move_group::moveit_move_group_capabilities_base )
list(APPEND _IMPORT_CHECK_FILES_FOR_moveit_ros_move_group::moveit_move_group_capabilities_base "${_IMPORT_PREFIX}/lib/libmoveit_move_group_capabilities_base.so.2.9.0" )
