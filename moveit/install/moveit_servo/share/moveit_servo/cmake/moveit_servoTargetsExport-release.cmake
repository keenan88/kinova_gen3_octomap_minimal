...
set_target_properties(moveit_servo::moveit_servo_lib_cpp PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libmoveit_servo_lib_cpp.so.2.9.0"
  IMPORTED_SONAME_RELEASE "libmoveit_servo_lib_cpp.so.2.9.0"
  )

list(APPEND _IMPORT_CHECK_TARGETS moveit_servo::moveit_servo_lib_cpp )
list(APPEND _IMPORT_CHECK_FILES_FOR_moveit_servo::moveit_servo_lib_cpp "${_IMPORT_PREFIX}/lib/libmoveit_servo_lib_cpp.so.2.9.0" )
...
set_target_properties(moveit_servo::moveit_servo_lib_ros PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libmoveit_servo_lib_ros.so.2.9.0"
  IMPORTED_SONAME_RELEASE "libmoveit_servo_lib_ros.so.2.9.0"
  )

list(APPEND _IMPORT_CHECK_TARGETS moveit_servo::moveit_servo_lib_ros )
list(APPEND _IMPORT_CHECK_FILES_FOR_moveit_servo::moveit_servo_lib_ros "${_IMPORT_PREFIX}/lib/libmoveit_servo_lib_ros.so.2.9.0" )
