...
set_target_properties(moveit_ros_planning_interface::moveit_common_planning_interface_objects PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libmoveit_common_planning_interface_objects.so.2.9.0"
  IMPORTED_SONAME_RELEASE "libmoveit_common_planning_interface_objects.so.2.9.0"
  )

list(APPEND _IMPORT_CHECK_TARGETS moveit_ros_planning_interface::moveit_common_planning_interface_objects )
list(APPEND _IMPORT_CHECK_FILES_FOR_moveit_ros_planning_interface::moveit_common_planning_interface_objects "${_IMPORT_PREFIX}/lib/libmoveit_common_planning_interface_objects.so.2.9.0" )
...
set_target_properties(moveit_ros_planning_interface::moveit_planning_scene_interface PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libmoveit_planning_scene_interface.so.2.9.0"
  IMPORTED_SONAME_RELEASE "libmoveit_planning_scene_interface.so.2.9.0"
  )

list(APPEND _IMPORT_CHECK_TARGETS moveit_ros_planning_interface::moveit_planning_scene_interface )
list(APPEND _IMPORT_CHECK_FILES_FOR_moveit_ros_planning_interface::moveit_planning_scene_interface "${_IMPORT_PREFIX}/lib/libmoveit_planning_scene_interface.so.2.9.0" )
...
set_target_properties(moveit_ros_planning_interface::moveit_move_group_interface PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libmoveit_move_group_interface.so.2.9.0"
  IMPORTED_SONAME_RELEASE "libmoveit_move_group_interface.so.2.9.0"
  )

list(APPEND _IMPORT_CHECK_TARGETS moveit_ros_planning_interface::moveit_move_group_interface )
list(APPEND _IMPORT_CHECK_FILES_FOR_moveit_ros_planning_interface::moveit_move_group_interface "${_IMPORT_PREFIX}/lib/libmoveit_move_group_interface.so.2.9.0" )
