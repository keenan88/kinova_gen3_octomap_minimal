...
set_target_properties(moveit_kinematics::moveit_cached_ik_kinematics_base PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libmoveit_cached_ik_kinematics_base.so.2.9.0"
  IMPORTED_SONAME_RELEASE "libmoveit_cached_ik_kinematics_base.so.2.9.0"
  )

list(APPEND _IMPORT_CHECK_TARGETS moveit_kinematics::moveit_cached_ik_kinematics_base )
list(APPEND _IMPORT_CHECK_FILES_FOR_moveit_kinematics::moveit_cached_ik_kinematics_base "${_IMPORT_PREFIX}/lib/libmoveit_cached_ik_kinematics_base.so.2.9.0" )
...
set_target_properties(moveit_kinematics::moveit_cached_ik_kinematics_plugin PROPERTIES
  IMPORTED_LINK_DEPENDENT_LIBRARIES_RELEASE "moveit_kinematics::moveit_kdl_kinematics_plugin;moveit_kinematics::moveit_srv_kinematics_plugin;moveit_kinematics::moveit_cached_ik_kinematics_base"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libmoveit_cached_ik_kinematics_plugin.so.2.9.0"
  IMPORTED_SONAME_RELEASE "libmoveit_cached_ik_kinematics_plugin.so.2.9.0"
  )

list(APPEND _IMPORT_CHECK_TARGETS moveit_kinematics::moveit_cached_ik_kinematics_plugin )
list(APPEND _IMPORT_CHECK_FILES_FOR_moveit_kinematics::moveit_cached_ik_kinematics_plugin "${_IMPORT_PREFIX}/lib/libmoveit_cached_ik_kinematics_plugin.so.2.9.0" )
...
set_target_properties(moveit_kinematics::moveit_srv_kinematics_plugin PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libmoveit_srv_kinematics_plugin.so.2.9.0"
  IMPORTED_SONAME_RELEASE "libmoveit_srv_kinematics_plugin.so.2.9.0"
  )

list(APPEND _IMPORT_CHECK_TARGETS moveit_kinematics::moveit_srv_kinematics_plugin )
list(APPEND _IMPORT_CHECK_FILES_FOR_moveit_kinematics::moveit_srv_kinematics_plugin "${_IMPORT_PREFIX}/lib/libmoveit_srv_kinematics_plugin.so.2.9.0" )
